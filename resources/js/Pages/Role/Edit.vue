<template>
    <Head>
        ...
        <meta name="edit Role" content="edit Role" />
    </Head>
        ...
        <Card>
            ...
            <main class="grid items-start grid-cols-1 gap-4 lg:grid-cols-4">
                ...
                <div class="grid grid-cols-1 space-y-1 lg:col-span-3">
                    <h2 class="block w-full text-lg font-semibold">
                        Permissions
                    </h2>
                    <ul
                    ...
                    >
                        <li
                            class="flex items-center col-span-12 space-x-1 lg:col-span-4 md:col-span-6"
                            v-for="(permission, i) in props.permissions"
                            :key="i"
                        >
                            <input
                    ...
                    <Alert
                        @onClose="form.errors.permissions = null"
            ...
            <div class="my-4 space-x-1">
                <Button
                    @onClick="form.patch(route(`roles.update`, props.role.id))"
...
function selectPermission(event) {
    ...
    if (event.target.checked) {
        ...
        form.permissions = form.permissions.filter(
            (permission) => permission.toString().toLowerCase() != permName
        );
    }
}
</script>
