                ...
                <div class="relative overflow-x-auto shadow">
                    ...
                    >
                            ...
                            <tr>
                                ...
                                >
                                    <div
                                        ...
                                        :class="{
                                            'justify-center': !showUserAddress,
                                            'w-64 lg:w-full': showUserAddress
                                        }"
                                    >
                                        <input
                                            @change="
                                            ...
                                            "
                                            type="checkbox"
                                            id="radioShowUserAddress"
                                            class="default:ring-4"
                                        />
                                        <label
                                            v-show="showUserAddress"
                                            for="radioShowUserAddress"
                                            >Address</label
                                        >
                                    </div>
                                </th>
                        ...
                        <tbody>
                            ...
                            >
                                <td
                                    class="w-16 h-16 text-gray-900 align-top border border-slate-500"
                                >
                                    <ImgOrRandColor
                                        class="flex justify-center"
                                        :payload="user.details.avatar"
                                    >
                                        <span
                                            class="self-center font-bold text-white"
                                            >{{
                                                tap(
                                                    user.name,
                                                    (name) =>
                                ...
                                <td
                                    class="px-4 py-4 text-gray-900 align-top border border-slate-500"
                                >
                                    {{ user.email }}
                                </td>
                                <td
