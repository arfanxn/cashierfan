            ...
            >
                <div class="flex flex-col space-y-1 lg:col-span-1">
                    <InputImage
                        ...
                        @onInput="({ file }) => (form.avatar = file)"
                        :previewImgURL="form.avatar"
                        id="inpUserImg"
                        @onError="
                            ({ message }) => (form.errors.avatar = message)
                        "
                    >
                        <div
                    ...
                    <Alert
                        @onClose="form.errors.avatar = null"
                ...
                >
                    ...
                    <div class="flex flex-col space-y-1 lg:col-span-1">
                        ...
                        />
                        <Alert
                            @onClose="form.errors.email = null"
                    ...
                    <div class="flex flex-col space-y-1 lg:col-span-1">
                        <Input
                            :value="props.user.details.phone_number"
                            id="inpPhoneNum"
                        ...
                        />
                        <Alert
                            @onClose="form.errors.phone_number = null"
                    ...
                    <div class="flex flex-col space-y-1 lg:col-span-2">
                        <Textarea
                            :value="props.user.details.address"
                            id="inpAddress"
                            placeholder="Address"
                            class="rounded placeholder:text-slate-700"
                    ...
                    <div
                        ...
                        class="grid grid-cols-1 gap-4 lg:grid-cols-2 col-span-full"
                    >
                        <div class="flex flex-col space-y-1 lg:col-span-1">
                            <Input
                                id="inpPassword"
                            ...
                            />
                            <Alert
                                @onClose="form.errors.password = null"
                        ...
                        <div class="flex flex-col space-y-1 lg:col-span-1">
                            ...
                            />
                            <Alert
                                @onClose="form.errors.confirm_password = null"
                ...
                <div class="grid items-start grid-cols-1 col-span-full">
                    <div class="flex flex-col space-y-1">
                        ...
                        <Alert
                            @onClose="form.errors.role = null"
                            :message="form.errors.role"
                        />
                    </div>
                    <ul
                        class="grid grid-cols-12 overflow-y-auto max-h-52 md:max-h-96 lg:max-h-full"
                    >
                        <li
                            class="flex items-center col-span-6 space-x-1 lg:col-span-2 md:col-span-4"
...
const form = useForm({
    avatar: tap(props.user.details.avatar, (avatar) =>
        avatar.length <= 7 ? null : avatar
    ),
